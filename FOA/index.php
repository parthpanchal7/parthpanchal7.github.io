...
<title>Home | Freedom of Art</title>
...
<section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="images/hero-bg.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
					...
					<div class="home-content">
						<div class="row home-content__main">
							<h3>Welcome to Freedom of Art</h3>
							<h1> We are a creative group <br> of people who design <br> influential brands and <br> digital experiences.</h1>
							<div class="home-content__buttons"> <a href="#contact" class="smoothscroll btn btn--stroke"> Start a Project </a> 
								<a href="#about" class="smoothscroll btn btn--stroke"> More About Us </a>
							</div>
						</div>
						<div class="home-content__scroll"> <a href="#about" class="scroll-link smoothscroll"> <span>Scroll Down</span> </a>
						</div>
				...
				<section id='about' class="s-about">
					<div class="row section-header has-bottom-sep" data-aos="fade-up">
						<div class="col-full">
							...
							<h1 class="display-1 display-1--light">We Are Freedom of Art</h1>
						</div>
					</div>
				...
				<section id='services' class="s-services">
					...
					<div class="row services-list block-1-2 block-tab-full">
						<div class="col-block service-item" data-aos="fade-up">
							<div class="service-icon"> <i class="icon-paint-brush"></i>
							</div>
							<div class="service-text">
								<h3 class="h2">3D Interior & Exterior Rendering</h3>
						...
						<div class="col-block service-item" data-aos="fade-up"><div class="service-icon"> 
					...
					<div class="col-block service-item" data-aos="fade-up">
						...
						<div class="service-text">
							<h3 class="h2">Product Rendering</h3>
							<p>Nemo cupiditate ab quibusdam quaerat impedit magni. Earum suscipit ipsum laudantium. Quo delectus est. Maiores voluptas ab sit natus veritatis ut. Debitis nulla cumque veritatis. Sunt suscipit voluptas ipsa in tempora esse soluta sint.</p>
						</div>
					</div>
					<div class="col-block service-item" data-aos="fade-up">
					...
					<div class="col-block service-item" data-aos="fade-up">
						...
						<div class="service-text">
							<h3 class="h2">Website Design & Development</h3>
							<p>Nemo cupiditate ab quibusdam quaerat impedit magni. Earum suscipit ipsum laudantium. Quo delectus est. Maiores voluptas ab sit natus veritatis ut. Debitis nulla cumque veritatis. Sunt suscipit voluptas ipsa in tempora esse soluta sint.</p>
						</div>
					</div>
				</div>
							...
							<div class="masonry__brick" data-aos="fade-up">
								<div class="item-folio">
									<div class="item-folio__thumb">
										<a href="images/work/01.jpg" class="thumb-link" title="Shutterbug" data-size="1050x700"> <img src="images/work/thumb/01_thumb.png"  alt=""> </a></div>
										<div class="item-folio__text">
											<h3 class="item-folio__title"> Shutterbug</h3>
											<p class="item-folio__cat"> Branding</p>
										</div>
										<a href="#" class="item-folio__project-link" title="Project link"> <i class="icon-link"></i> </a>
								...
								<div class="masonry__brick" data-aos="fade-up">
									<div class="item-folio">
										<div class="item-folio__thumb">
											<a href="images/work/bed .jpg" class="thumb-link" title="Woodcraft" data-size="1050x700"> <img src="images/work/thumb/bed_thumb.png" alt=""> </a>
										</div>
										<div class="item-folio__text">
										...
										<a href="#" class="item-folio__project-link" title="Project link"> <i class="icon-link"></i> </a>
										<div class="item-folio__caption"><p>Vero molestiae sed aut natus excepturi. Et tempora numquam. Temporibus iusto quo.Unde dolorem corrupti neque nisi.</p>
										</div>
									</div>
								</div>
								<div class="masonry__brick" data-aos="fade-up">
									<div class="item-folio">
										<div class="item-folio__thumb"> <a href="images/work/Cam_01_sample.jpg" class="thumb-link" title="The Beetle Car" data-size="1050x700"> <img src="images/work/thumb/Cam_01_sample_thumb.png" alt=""> </a>
										</div>
										<div class="item-folio__text">
								...
								<div class="masonry__brick" data-aos="fade-up">
									<div class="item-folio">
										<div class="item-folio__thumb"> <a href="images/work/sindhu havan cafe.jpg" class="thumb-link" title="Grow Green" data-size="1050x700"> <img src="images/work/thumb/cafe_thumb.png" alt=""> </a>
										</div>
										<div class="item-folio__text">
								...
								<div class="masonry__brick" data-aos="fade-up">
									<div class="item-folio">
										<div class="item-folio__thumb"> <a href="images/work/sindhu havan cafe_02.jpg" class="thumb-link" title="Guitarist" data-size="1050x700"> <img src="images/work/thumb/cafe_thumb_2.png" alt=""> </a>
										</div>
										<div class="item-folio__text">
								...
								<div class="masonry__brick" data-aos="fade-up">
									<div class="item-folio">
										<div class="item-folio__thumb"> <a href="images/work/sindhu havan cafe_03.jpg" class="thumb-link" title="Palmeira" data-size="1050x700"> <img src="images/work/thumb/cafe_thumb_3.png" alt=""> </a>
										</div>
										<div class="item-folio__text">
				...
				<section id="clients" class="s-clients">
					<div class="row section-header" data-aos="fade-up">
						<div class="col-full">
							...
							<h1 class="display-2">Freedom of Art has been honored to partner up with these clients</h1>
						</div>
					</div>
						...
						<div class="col-full">
							<div class="testimonials">
								<div class="testimonials__slide">
									...
									<img src="images/avatars/xuser-01.jpg.pagespeed.ic.TQ57ViZCls.jpg" alt="Author image" class="testimonials__avatar">
								...
								<div class="testimonials__slide">
									...
									<img src="images/avatars/xuser-05.jpg.pagespeed.ic.VeExVGrouX.jpg" alt="Author image" class="testimonials__avatar">
									<div class="testimonials__info"> 
								...
								<div class="testimonials__slide">
									...
									<img src="images/avatars/xuser-02.jpg.pagespeed.ic.h9SZyNXnWw.jpg" alt="Author image" class="testimonials__avatar">
									<div class="testimonials__info"> 
						...
						<div class="contact-secondary">
							<div class="contact-info">
								...
								<div class="cinfo">
									...
									<p> C.G. Road<br> Ahmedabad, GJ<br> 380009, INDIA</p>
								</div>
								<div class="cinfo">
									<h5>Email Us At</h5>
									<p> 
										<a href="#" class="__cf_email__" data-cfemail="96f5f9f8e2f7f5e2d6f1fafff8e2e5ffe2f3b8f5f9fb">info@freedomofart.in</a>
										<br> 
										<a href="#" class="__cf_email__" data-cfemail="99f0f7fff6d9fef5f0f7edeaf0edfcb7faf6f4">rahul@freedomofart.in</a>
									</p>
								</div>
								<div class="cinfo">
									<h5>Call Us At</h5>
